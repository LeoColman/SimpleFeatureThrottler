...
group = "com.kerooker.simplefeaturethrottler"
version = "1.0.0"
...
publishing {
    ...
    publications {
        ...
        register("mavenJava", MavenPublication::class) {
            ...
            pom {
                name.set("SimpleFeatureThrottler")
                description.set("Simple Feature Throttler")
                url.set("https://www.github.com/Kerooker/SimpleFeatureThrottler")
                
                
                scm {
                    connection.set("scm:git:http://www.github.com/Kerooker/SimpleFeatureThrottler/")
